...
class BigDFTBaseWorkChain(BaseRestartWorkChain):
    ...
    def define(cls, spec):
        ...
        spec.expose_inputs(BigDFTCalculation, namespace=BigDFTBaseWorkChain._workchain_namespace)
    ...
    def setup(self):
        ...
        self.ctx.inputs = AttributeDict(self.exposed_inputs(BigDFTCalculation, BigDFTBaseWorkChain._workchain_namespace))
